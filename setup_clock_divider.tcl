...
# File: setup_clock_divider.tcl
# Generated on: Wed Dec 23 16:56:01 2020
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "clock_divider"]} {
		puts "Project clock_divider is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists clock_divider]} {
		project_open -revision clock_divider clock_divider
	} else {
		project_new -revision clock_divider clock_divider
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "16:24:47  DECEMBER 23, 2020"
